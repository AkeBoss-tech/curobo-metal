...
def test_sdist_requires_single_root_and_release_documents() -> None:
    sdist = Path("curobo_metal-0.1.0a1.tar.gz")
    valid = [
        "curobo_metal-0.1.0a1/LICENSE",
        "curobo_metal-0.1.0a1/THIRD_PARTY_NOTICES.md",
        "curobo_metal-0.1.0a1/README.md",
        "curobo_metal-0.1.0a1/pyproject.toml",
        "curobo_metal-0.1.0a1/src/curobo/__init__.py",
    ]
