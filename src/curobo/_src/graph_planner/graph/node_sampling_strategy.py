...
class NodeSamplingStrategy:
    ...
    def get_feasible_sample_set(self, x_samples: torch.Tensor) -> torch.Tensor:
    ...
    def generate_feasible_action_samples(self, num_samples: int) -> torch.Tensor:
    ...
    def generate_feasible_samples_in_ellipsoid(
        ...
        x_goal: torch.Tensor,
        num_samples: int,
        max_sampling_radius: torch.Tensor | float,
    ) -> torch.Tensor:
