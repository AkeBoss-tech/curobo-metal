...
class _MotionRetargeterCfgPortableMixin:
    @property
    ...
    def with_device(self, device_cfg: DeviceCfg | str | Mapping[str, Any]) -> "MotionRetargeterCfg":
        return self._with_device(device_cfg)

    def with_tool_pose_criteria(self, *args, **kwargs) -> "MotionRetargeterCfg":
        return self._with_tool_pose_criteria(*args, **kwargs)

    def with_scene_model(self, scene_model: Optional[Any]) -> "MotionRetargeterCfg":
        return self._with_scene_model(scene_model)


@dataclass
class MotionRetargeterCfg(_MotionRetargeterCfgPortableMixin):
    ...
    @property
    def _batch_shape_value(self) -> tuple[int, int]:
    ...
    def _with_device(self, device_cfg: DeviceCfg | str | Mapping[str, Any]) -> "MotionRetargeterCfg":
    ...
    def _with_scene_model(self, scene_model: Optional[Any]) -> "MotionRetargeterCfg":
