...
def convert_curobo_to_xrdf(
    ...
    if "collision_spheres" in kinematics_dict:
        ...
        buffer_val = kinematics_dict.get("collision_sphere_buffer")
    ...
    sc_ignore = kinematics_dict.get("self_collision_ignore")
    self_collision_section["ignore"] = deepcopy(sc_ignore) if sc_ignore is not None else []

    sc_buffer = kinematics_dict.get("self_collision_buffer")
    ...
    lock_joints = kinematics_dict.get("lock_joints", {})
