...
| Reachable IK fixture | 977 ms | 2500 ms |
| Trajectory optimization fixture | 228 ms | 800 ms |
...
The IK and trajectory ceilings include headroom for sustained MPS thermal
variance on the shared development Mac; their checked medians remain the normal
baseline.
