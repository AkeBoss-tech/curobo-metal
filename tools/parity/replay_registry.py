...
_ROWS = [
    ...
    ("optim.particle_evolution", "evolution_strategies", 0, 0, "particle", "invalid_covariance", "facade_lifecycle", "semantic EvolutionStrategies facade replay; cross-device random samples and exact solutions are intentionally not compared"),
